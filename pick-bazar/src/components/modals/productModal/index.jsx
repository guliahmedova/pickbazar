...
const ProductCardModal = ({ choldren, openProductModal , setOpenProductModal}) => {
    return (
        <>
            {openProductModal && (
                <div className={styles.productcard_modal_bg}>
                      <button className={styles.modal_close_btn} onClick={() => setOpenProductModal(false)}>
